...
const displayBoston = element => {
    ...
    headerimg.src = '/images/boston.jpg';
    //... \u00A0 this add space in the string interpolation
    label1.textContent = `Abbreviation: \u00A0 \u00A0 \u00A0 \u00A0 ${element[1].abbreviation}`;
    label2.textContent = `City Name: \u00A0 \u00A0 \u00A0 \u00A0 \u00A0 \u00A0 ${element[1].city}`;
    label3.textContent = `Conference: \u00A0 \u00A0 \u00A0 \u00A0 \u00A0 \u00A0 ${element[1].conference}`;
    label4.textContent = `Team Full Name: \u00A0 \u00A0 ${element[1].full_name}`;
